                        ...
                        <div className="col-md-6 col-lg-3 mt-2">
                            ...
                            <HomeSharpIcon style={{backgroundColor: "#F95911",color: "#FFFFFF",borderRadius:" 30%",marginRight: "10px", width:"40px", height:"37px", padding:"6px",borderRadius:"50%", marginBottom:"188px"}} />
                                <div className="cta-text ms-5">
                                    ...
                                    <a className="Cursor" href="#"><p className="text-start" style={{color:"#AB8282"}}>6 A Shivampuri colony,<br /> Bholaram Ustadmarg,<br /> Indore, 452001</p> </a>
                        ...
                        <div className="col-md-6 col-lg-3 mt-2">
                            ...
                            <CallSharpIcon style={{backgroundColor: "#F95911",color: "#FFFFFF",borderRadius:" 30%",marginRight: "10px", width:"40px", height:"37px", padding:"6px",borderRadius:"50%", marginBottom:"46px"}} />
                                 <div className="cta-text ms-5">
                                    ...
                                    <a className="Cursor" href="#"><span style={{color:"#AB8282"}} className="text-start">9009700155</span></a>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3 mt-2">
                            <div className="single-cta">
                            <MailOutlineSharpIcon style={{backgroundColor: "#F95911",color: "#FFFFFF",borderRadius:" 30%",marginRight: "10px", width:"40px", height:"37px", padding:"6px",borderRadius:"50%",marginBottom:"46px"}} />
                                <div className="cta-text ">
                                    <h4 className="text-start">Mail us</h4>
                                    <a className="Cursor" href="#"><span style={{color:"#AB8282"}} className="text-start">royalhousemakers@gmail.com</span></a>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-3 mt-2">
                            <div className="footer-social-icon single-cta" style={{display:"flex"}}>
                            <AddCircleOutlineSharpIcon style={{backgroundColor: "#F95911",color: "#FFFFFF",borderRadius:" 30%",marginRight: "10px", width:"40px", height:"37px", padding:"6px",borderRadius:"50%"}} />
                                <span>Follow: </span>
